		...
		<table align="left" width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td valign="top">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://www.sourceforge.net/projects/dosbox" target="_blank"><img src="http://sourceforge.net/sflogo.php?group_id=52551&amp;type=1" width="88" height="31" border="0" alt="SourceForge.net Logo"></a><br>
			...
			<map name="dosbox">
			  ...
			  <area shape="rect" coords="242,4,273,27" href="wiki/index.php" alt="Frequently Asked Questions">
